...
|---|---|---|---|---|
| 1 | **selfh.st directory** ([`cdn.jsdelivr.net/gh/selfhst/cdn@main/directory/software.json`](https://cdn.jsdelivr.net/gh/selfhst/cdn@main/directory/software.json)) | **In progress** (~92%) | 1,274 self-hostable apps sorted by GitHub stars | Bot's primary source since 2026-04. State tracked in [`selfhst-progress.json`](selfhst-progress.json) (per-app processing status) + [`selfhst-software.json`](selfhst-software.json) (cached source data). Process in star-rank order. |
| 2 | **awesome-selfhosted-data** ([`github.com/awesome-selfhosted/awesome-selfhosted-data`](https://github.com/awesome-selfhosted/awesome-selfhosted-data)) | **Queued** | ~1,500 entries categorized + license-tagged. Renders as <https://awesome-selfhosted.net/>. | YAML format (one file per software under `software/*.yml`). Significant overlap with selfh.st — dedupe by GitHub repo URL + name match against catalog. Pick up after selfh.st finishes. |
