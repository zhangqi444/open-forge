...
services:
  pocket-id:
    image: ghcr.io/pocket-id/pocket-id:v2.7.0   # pin specific version
...
- **v2.x major upgrade** — v2.7.0 is current; v1→v2 is a major version change. Back up database before upgrading and read upstream release notes.
